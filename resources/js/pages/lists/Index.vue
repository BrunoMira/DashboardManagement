        ...
        <div class="space-y-6 p-6">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-muted-foreground">Manage your lists here.</p>
                </div>
                ...
                >
                    ...
                    <CardContent>
                        ...
                        <div class="flex gap-2">
                            <Link
                                :href="
                                    tasks.index({ query: { list_id: list.id } })
                                "
                                class="flex-1"
                            >
                                <Button
            ...
            <Card v-else>
                ...
                >
                    <p class="mb-4 text-muted-foreground">No lists found.</p>
            ...
            >
                <Form @submit.prevent="createList" class="spaces-y-4">
                    <div class="space-y-2">
                        ...
                        <Input
                            ...
                            required
                            :aria-invalid="
                                createForm.errors?.name ? 'true' : 'false'
                            "
                        />
                    ...
                    <div class="space-y-2">
                        ...
                        <Input
                            ...
                            :aria-invalid="
                                createForm.errors?.color ? 'true' : 'false'
                            "
                        />
            ...
            >
                <Form @submit.prevent="updateList" class="spaces-y-4">
                    <div class="space-y-2">
                        <label for="name">Name</label>
                        <Input
                            id="name"
                            ...
                            required
                            :aria-invalid="
                                editForm.errors?.name ? 'true' : 'false'
                            "
                        />
                    ...
                    <div class="space-y-2">
                        ...
                        <Input
                            ...
                            placeholder="Color"
                            :aria-invalid="
                                editForm.errors?.color ? 'true' : 'false'
                            "
                        />
